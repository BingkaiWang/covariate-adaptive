...
summary_table[2,1] <- CADE(Y = Y, A = A, Strata = I.S, pi = pi, tau = pi * (1-pi), family = "binomial")[2]
summary_table[2,2] <- CADE(Y = Y, A = A, Strata = I.S, pi = pi, W = W, tau = pi * (1-pi), family = "binomial")[2]
